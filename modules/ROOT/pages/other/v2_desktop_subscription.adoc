...
| 200
| Response Body
| JSON dictionary with 'status', 'channel', 'user_id', 'state', and 'reachable' keys.
[cols="1,3a", stripes="even"]
!===
! status
! 'ok'
...
----
{"status":"ok", "channel":"desktop_push", "user_id":"example_user", "state":"opt_in", "reachable": false}
----
|===
...
| 200
| Response Body
| JSON dictionary with 'status', 'channel', 'user_id', 'previous_state', 'state', and 'reachable' keys.
[cols="1,3a", stripes="even"]
!===
! status
! 'ok'
...
| [source, json, subs="attributes"]
----
{"status":"ok", "channel":"desktop_push", "user_id":"example_user", "previous_state": "opt_out", state":"opt_in", "reachable": false}
----
|===
