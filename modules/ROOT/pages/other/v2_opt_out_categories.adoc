...
'show_badge' is a boolean indicating if a badge should be shown when a push notification with this Opt Out Category is received on a device. This may be overridden on a per notification basis on iOS. This may _not_ be changed on Android. +
...
| show_badge
| A boolean indicating if a badge should be shown when a push notification with this Opt Out Category is received on a device. This may be overridden on a per notification basis on iOS. This may _not_ be changed on Android.
| archived
