...
! 'email'
! previous_state
! The previous subscription status state for this email address. One of 'opt_out', 'available', or 'opt_in'
! state
! The newly set state. One of 'opt_out', 'available', or 'opt_in'
! delivery_fault
! true if an error was encountered attempting to send to the email address, otherwise false
! email
