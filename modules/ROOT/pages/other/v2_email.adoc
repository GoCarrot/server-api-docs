...
:response-code: 200
:response-body: JSON dictionary with a 'status' key. 'status' will be 'removed'.
:response-example: {"status":"removed"}
include::partial$response.adoc[]

=== Email Already Absent Success Response

:response-code: 200
:response-body: JSON dictionary with a 'status' key. status' will be 'email_absent'.
:response-example: {"status":"email_absent"}
include::partial$response.adoc[]
