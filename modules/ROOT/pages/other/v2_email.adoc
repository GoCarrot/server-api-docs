...
== Retrieving Recent Opt Outs
:endpoint: v2/email/recent_unsubs
[cols="1,3a", stripes="even"]
|===
| Endpoint
| https://api.gocarrot.com/{endpoint}
...
| [source, json, subs="attributes"]
----
{"status":"ok", "opt_outs": [{"device_key": "john.smith@gmail.com", "updated_at": "2024-09-01T12:34:56Z", "reason": "opt_out"},{"device_key": "jane.doe@gmail.com", "updated_at": "2024-09-01T12:34:56Z", "reason": "spam"}]}
----
|===
