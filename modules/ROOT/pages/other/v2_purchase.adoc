...
| happened_at
| The time in UTC at when the purchase happened. Must be in ISO8601 format, e.g. "2018-08-23 17:00:00". Cannot be in the future. If not provided, the purchase will be recorded as happening when the API call is made.
|===
