...
----
{"status":"ok", "channel":"push", "user_id":"example_user", "state":"opt_in", "reachable": false}
----
|===
...
| [source, json, subs="attributes"]
----
{"status":"ok", "channel":"push", "user_id":"example_user", "previous_state": "opt_out", state":"opt_in", "reachable": false}
----
|===
